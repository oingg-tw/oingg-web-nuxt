  ...
  app: {
    head: {
      ...
      script: [
        ...
        {
          // `innerHTML`, not the older `children` — unhead's own script type dropped that alias, and
          // it was the only thing keeping this file out of a clean typecheck（2026-09-23）. Same
          // rendered output.
