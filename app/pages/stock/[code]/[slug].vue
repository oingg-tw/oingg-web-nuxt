...
// /stock/{code}/{slug} — the badge-page family (2026-09-20), generalizing f-score.vue's per-
// stock × per-metric template to other guru badges. This is a catch-all sibling of the eight
// named sub-pages (balance-sheet.vue, dividend.vue, …) — Nuxt resolves a static route before a
// dynamic one, so those keep winning; an unrecognized `slug` here throws a REAL 404 rather than
// rendering an empty page, so a typo'd URL behaves the same way whether it lands here or on a
// named route.
//
