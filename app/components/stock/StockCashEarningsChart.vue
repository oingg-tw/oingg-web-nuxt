  ...
  <el-card class="cash-earnings-chart" shadow="never" :body-style="{ padding: '4px 4px 8px' }">
    <template #header>
      <div class="cash-earnings-chart__header">
        <span class="cash-earnings-chart__title">
          每股現金獲利
    ...
    <template v-else>
      <VChart v-loading="history.pending.value" class="cash-earnings-chart__chart" :option="option" :init-options="{ renderer: 'svg' }" autoresize />
