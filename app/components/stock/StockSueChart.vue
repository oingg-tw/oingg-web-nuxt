  ...
  <el-card class="sue-chart" shadow="never">
    <template #header>
      <div class="sue-chart__header">
        <StockCardTitle title="標準化未預期盈餘 (SUE)" :info-text="INFO_TEXT" metric-code="sue" />
    ...
    <template v-else>
      <SharedChart v-loading="history.pending.value" class="sue-chart__chart" :option="option" :init-options="{ renderer: 'svg' }" autoresize />
