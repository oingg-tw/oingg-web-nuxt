...
<template>
  <div v-loading="stockPending" class="stock-metric-page">
    ...
    <template v-else>
      <StockSummaryCard :stock="stock" :website="profile?.website ?? null" :is-favorite="isFavorite" :short-name="stockShortName" :topic="metricPage.topic" hide-stat-grid @toggle-favorite="toggleFavorite" />
