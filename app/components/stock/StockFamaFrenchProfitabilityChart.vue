  ...
  <el-card class="fama-french-profitability-chart" shadow="never">
    <template #header>
      <div class="fama-french-profitability-chart__header">
        <StockCardTitle title="Fama-French 營業獲利力" :info-text="INFO_TEXT" />
    ...
    <template v-else>
      <SharedChart v-loading="history.pending.value" class="fama-french-profitability-chart__chart" :option="option" :init-options="{ renderer: 'svg' }" autoresize />
