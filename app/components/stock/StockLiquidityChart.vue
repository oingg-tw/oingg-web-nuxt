  ...
  <el-card class="liquidity-chart" shadow="never" :body-style="{ padding: '4px 4px 8px' }">
    <template #header>
      <div class="liquidity-chart__header">
        <StockCardTitle title="短期流動性" :info-text="INFO_TEXT" metric-code="currentRatio" />
    ...
    <template v-else>
      <SharedChart v-loading="history.pending.value" class="liquidity-chart__chart" :option="option" :init-options="{ renderer: 'svg' }" autoresize />
