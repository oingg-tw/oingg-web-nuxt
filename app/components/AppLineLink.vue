...
// homepage's own footer) — mirrors AppGithubLink.vue.
//
// TODO: href is empty pending the real LINE 官方帳號/社群 link (user's own words: "先空著" —
// leave it empty for now). @click.prevent stops it from navigating anywhere (an empty href
// would otherwise reload the current page) until a real URL is filled in here.
const LINE_URL = ''
</script>
...
<template>
  <a
    ...
    aria-label="LINE"
    title="LINE"
    @click="!LINE_URL && $event.preventDefault()"
  >
